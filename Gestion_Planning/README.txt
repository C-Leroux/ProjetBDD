...
- une fenetre avec phpMyAdmin s'ouvre, cliquer sur "Databases" (ou "Base de données") en haut a gauche de l'ecran
...
- telecharger la librairy (qui sert a se connecter a la base de donnee)
